...
import net.javaguides.registration.dao.depositdao;
...
if(u==1){
RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/views/showdeposit.jsp");
dispatcher.forward(request, response);
}else
{
